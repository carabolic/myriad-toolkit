...
#include "myriad/core/exceptions.h"
#include "myriad/core/types.h"
#include "myriad/core/types/MyriadEnumSet.h"
...
void MyriadEnumSet::initialize(istream& in, size_t& currentLineNumber)
{
    ...
    if (currentState != END)
    {
        throw RuntimeException("Unexpected state in CombinedPrFunction reader at line " + std::to_string(currentLineNumber));
    }
}
