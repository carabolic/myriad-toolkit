/*
 * Copyright 2014 DIMA Research Group, TU Berlin
 *
...
//        a = (a * a) % N;
    ...
    bool isPrime(I64u N, const I16u k) {
        if (N > 2251799813685248ULL) {
            throw Myriad::IntegerOverflowException(format("Integer %Lu is too big for modular arithmetic operations", N));
        }
